...
public class UnitTests {
    ...
    @Rubric(
            ...
            points = 10.0,
            reference = "This Test fails when: The Triangle area is miscalculated"
    )
    @Test
    ...
    @Rubric(
            ...
            points = 10.0,
            reference = "This Test fails when: The Triangle perimeter is miscalculated"
    )
    @Test
    ...
    public void testSphereVolume() {
        ...
        assertEquals((4.0 / 3.0) * Math.PI * 12.167, Logic.sphereVolume((int) 2.3), 0.001);
    ...
    public void testSphereSurfaceArea() {
        ...
        assertEquals(21.16 * Math.PI, Logic.sphereSurfaceArea((int) 2.3), 0.001);
    }
}
