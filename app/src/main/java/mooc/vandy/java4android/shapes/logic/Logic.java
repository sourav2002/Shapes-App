...
public class Logic
    ...
    public void process() {
        ...
        switch (shapeForCalculations) {
            ...
            case Sphere:
                ...
                mOut.println(format(Locale.getDefault(), "%.2f", sphereVolume((int) mRadius)));
                mOut.println();

                mOut.print("A sphere with radius " + mRadius + " has surface area of: ");
                mOut.println(format(Locale.getDefault(), "%.2f", sphereSurfaceArea((int) mRadius)));
                mOut.println();
            ...
            case Circle:
                ...
                mOut.println(format(Locale.getDefault(), "%.2f", circleCircumference((int) mRadius)));
                mOut.println();

                mOut.print("A circle with radius " + mRadius + " has area of: ");
                mOut.println(format(Locale.getDefault(), "%.2f", circleArea((int) mRadius)));
                mOut.println();
                break;
            case Triangle:
                ...
                mOut.print("A right triangle with base "
                        ...
                        + mWidth
                        + " has area of: ");
                mOut.println(format(Locale.getDefault(),
                        "%.2f",
                        rightTriangleArea(mLength, mWidth)));
                mOut.println();
                break;
            default:
                break;
    ...
    public static double rectangleArea(double length, double width)    {
        return (double) ((double) length * width);
    }

    public static double rectanglePerimeter(double length, double width)    {
        return (double) ((double) 2*(length+ width));
    }
    ...
    public static double circleCircumference(double radius)    {
        return (double) ((double) 2* Math.PI*radius);
    }
    ...
    public static double rightTrianglePerimeter(double base, double height)    {
        return (double) ((double) base+height + Math.sqrt((base*base) + (height*height)));
    }

    public static double boxVolume(double length, double width, double depth)    {
        return (double) ((double) length*width*depth);
    }

    public static double boxSurfaceArea(double length, double width, double depth)    {
        return (double) ((double) (2*length*width) + (2*width*depth) + (2*depth*length));
    }

    public static double sphereVolume(double radius)    {
        return (double) ((double) (4.0/3.0)*(Math.PI)*(radius*radius*radius));
    }

    public static double sphereSurfaceArea(double radius)    {
        return (double) ((double) 4 * Math.PI * radius* radius);
    }
}
